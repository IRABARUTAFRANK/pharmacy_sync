export default function DatabaseBackedPage({ title, tables }: { title: string; tables: string }) {
  return <div style={{ maxWidth: 720, margin: "48px auto", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 14, padding: 32, textAlign: "center" }}>
    ...
    <div style={{ marginTop: 18, background: "var(--bg)", borderRadius: 8, padding: "10px 14px", fontFamily: 'var(--font-mono)', fontSize: 12, color: "var(--primary)" }}>{tables}</div>
  </div>
}
