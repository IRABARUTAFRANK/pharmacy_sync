...
import { checkExpiredStock, checkExpiringSoonStock, checkForecastAccuracyNotifications, checkLicenseExpiry, checkLowStockAlerts, checkOutOfStockAlerts, loadLiveAlerts, type LiveAlert } from './lib/alerts'
...
export default function App() {
  ...
  function renderPage() {
    switch (page) {
      ...
      case 'branch':        return <BranchSettingsPage key={branchSettingsFocus?.seq ?? 0} initialTab={branchSettingsFocus?.tab} onLogoSaved={setPharmacyLogoUrl} />
